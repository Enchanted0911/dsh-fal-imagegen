...
export const FAL_IMAGEGEN_GUIDANCE = [
  ...
  'FAL_KEY 在「设置 → 插件」的 fal 生图设置段配置（namespace dsh-fal-imagegen），密钥只存本机设置文档；生成消耗 fal 额度，图片由 fal 侧模型产出。用户提到「fal 生图 / 文生图 / 图生图」时即指本插件（与 AI 生图插件 dsh-imagegen 并存，本插件工具名一律带 fal_ 前缀）。',
].join('')
