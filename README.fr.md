# 🎨 dsh-fal-imagegen — Génération d'images native fal.ai pour DeepSeek Harness, v0.2.0
...
Génération d'images native [fal.ai](https://fal.ai) pour DeepSeek Harness (DSH) : une carte de configuration qui suit la langue de DSH, plus des outils d'agent qui parlent le protocole fal de bout en bout — sans passerelle compatible OpenAI entre les deux.

## Table des matières

- [Fonctionnalités](#fonctionnalités)
- [Génération asynchrone](#génération-asynchrone)
- [Alias de modèles](#alias-de-modèles)
- [Configuration](#configuration)
- [Installation](#installation)
- [Développement](#développement)
- [Source du catalogue du marché](#source-du-catalogue-du-marché)
- [Limites](#limites)
